...
class CowrieSSHFactory(factory.SSHFactory):
    ...
    def __init__(self, backend, pool_handler):
        log.msg("[DEBUG][factory.py][CowrieSSHFactory.__init__] Initializing SSH factory", system="cowrie")

        self.pool_handler = pool_handler
        self.backend: str = backend
        self.privateKeys = {}
        self.publicKeys = {}
        self.connection_counter = {'count': 0}

        log.msg("[DEBUG][factory.py][CowrieSSHFactory.__init__] Configuring SSH services: ssh-userauth and ssh-connection", system="cowrie")
    ...
    def startFactory(self) -> None:
        ...
        log.msg("[DEBUG][factory.py][CowrieSSHFactory.startFactory] Starting SSH factory and initializing keys", system="cowrie")
        ...
        log.msg("[DEBUG][factory.py][CowrieSSHFactory.startFactory] SSH factory calling startFactory()", system="cowrie")
        factory.SSHFactory.startFactory(self)
        log.msg("Ready to accept SSH connections")
        log.msg("[DEBUG][factory.py][CowrieSSHFactory.startFactory] SSH factory ready to accept connections", system="cowrie")

        

    def stopFactory(self) -> None:
        log.msg("[DEBUG][factory.py][CowrieSSHFactory.stopFactory] SSH factory stopping factory", system="cowrie")
    ...
    def buildProtocol(self, addr):
        ...
        """
        log.msg("[DEBUG][factory.py][CowrieSSHFactory.buildProtocol] Building SSH transport for new connection", system="cowrie")
        ...
        if self.backend == "proxy":
            ...
            t.connection_counter = self.connection_counter
        ...
        t.factory = self
        log.msg("[DEBUG][factory.py][CowrieSSHFactory.buildProtocol] Finished building protocol in factory", system="cowrie")
